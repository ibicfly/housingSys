      ...
      <div class="d_Confirm_Order_style">
        ...
        <div class="border clearfix" style="display: block">
               <span class="l_f">
                ...
                <a class="btn btn-danger" onclick="deletePart();" href=<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ request.getContextPath()+"/"%>managerRentHouseDealinit.do>批量删除</a>
               </span>
...
<div class="add_menber" id="add_menber_style" style="display:none">
  <form action=<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ request.getContextPath()+"/"%>adminAddRentHouseDeal.do id="addRentHouseDeal" enctype="multipart/form-data" method="post">
...
<div class="add_menber" id="update_menber_style" style="display:none">
  <form action=<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ request.getContextPath()+"/"%>adminUpdateRentHouseDeal.do id="updateRentHouseDeal" enctype="multipart/form-data" method="post">
  <ul class=" page-content">
    <li>
      <label class="label_name">经纪人ID：</label>
      <span class="add_name">
...
<script>
  ...
  function transpDel() {
		$.ajax({
			type : "GET",
			async : false,
			url : "<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ request.getContextPath()+"/"%>deleteRentHouseDealAjax.do"
		})
	}
  ...
  function transpDelPart() {
		$.ajax({
			type : "GET",
			async : false,
			url : "<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ request.getContextPath()+"/"%>deleteRentHouseDealPartAjax.do"
		})
	}
