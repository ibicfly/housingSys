    ...
    <div class="user-main">
      <div class="main-left fl">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li role="presentation" class="active"><a href=<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ request.getContextPath()+"/"%>jsp/html/MyHome/comment.jsp>我的评论</a></li>
           		...
           		for (Collect c: lb) {
	                ...
	                <div class="list" style="display: block">
	                  ...
	                  <div class="info-panel" style="float: left">
	                    <h2><a target="_blank"
	                           href=""><%=c.name %> </a>
	                       <form method="post" action=<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ request.getContextPath()+"/"%>userCancelBuildingComment.do>
            	...
            	for (Collect c: lr) {
	                ...
	                <div class="list" style="display: block">
	                  ...
	                  <div class="info-panel" style="float: left">
	                    <h2><a target="_blank"
	                           href=""><%=c.name %> </a>
	                      <form method="post" action=<%=request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+ request.getContextPath()+"/"%>userCancelRentComment.do>
